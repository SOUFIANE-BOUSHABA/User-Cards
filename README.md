...
Filtrer le tableau users pour ne garder que ceux dont fullName contient le texte tapé (en minuscule / majuscule insensible).

Réafficher les cartes avec le résultat filtré.
...
Sinon → afficher uniquement les users dont address.city correspond à la ville choisie.
